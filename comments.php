...
<h3 id="comments-respond">发表一条评论</h3>
...
<p>登陆为 <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a> │ <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account">登出 &raquo;</a></p>
...
<input name="submit" type="submit" id="commentSubmit" tabindex="5" value="发 表" />
